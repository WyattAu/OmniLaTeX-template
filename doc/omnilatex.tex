...
%
% NOTE: The doc/ directory follows the TDS (TeX Directory Structure)
% convention required for CTAN packaging.  It is NOT the general
% project documentation — that lives in docs/ (gallery, editor
