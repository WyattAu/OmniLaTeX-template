...
const PROFILES = [
  ...
  {id:'homework',       name:'Homework',           desc:'Homework assignment',            cls:'scrartcl', icon:'HW'},
  {id:'exam',           name:'Exam',               desc:'Exam paper',                     cls:'scrartcl', icon:'Ex'},
  {id:'research-proposal', name:'Research Proposal', desc:'Research proposal',           cls:'scrreprt', icon:'RP'},
  {id:'recipe',         name:'Recipe',             desc:'Recipe / instructions',          cls:'scrartcl', icon:'Rcp'},
  {id:'lecture-notes',  name:'Lecture Notes',      desc:'Lecture notes',                  cls:'scrartcl', icon:'LN'},
  {id:'syllabus',       name:'Syllabus',           desc:'Course syllabus',                cls:'scrartcl', icon:'Syl'},
  {id:'handout',        name:'Handout',            desc:'Handout / flyer',                cls:'scrartcl', icon:'HO'},
  {id:'memo',           name:'Memo',               desc:'Memorandum',                     cls:'scrartcl', icon:'Mem'},
  {id:'white-paper',    name:'White Paper',        desc:'White paper',                    cls:'scrartcl', icon:'WP'},
  {id:'invoice',        name:'Invoice',            desc:'Invoice / billing',              cls:'scrartcl', icon:'Inv'},
  {id:'beamer',         name:'Beamer',             desc:'Beamer presentation',            cls:'beamer',   icon:'Bmr'},
];

const INST_MAP = {
  none:'', tuhh:'tuhh', tum:'tum', eth:'eth',
  mit:'mit', stanford:'stanford', cambridge:'cambridge', tudelft:'tudelft',
  aalto:'aalto', chalmers:'chalmers', columbia:'columbia', epfl:'epfl',
  harvard:'harvard', imperial:'imperial', kit:'kit', ntnu:'ntnu',
  oxford:'oxford', princeton:'princeton', uoft:'uoft', yale:'yale',
};
...
const INST_LABELS = {
  none:'None', tuhh:'TUHH', tum:'TUM', eth:'ETH Zurich',
  mit:'MIT', stanford:'Stanford', cambridge:'Cambridge', tudelft:'TU Delft',
  aalto:'Aalto', chalmers:'Chalmers', columbia:'Columbia', epfl:'EPFL',
  harvard:'Harvard', imperial:'Imperial', kit:'KIT', ntnu:'NTNU',
  oxford:'Oxford', princeton:'Princeton', uoft:'U of T', yale:'Yale',
};
