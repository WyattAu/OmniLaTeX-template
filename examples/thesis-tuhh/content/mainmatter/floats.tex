    ...
    \begin{tikzpicture}
            ...
            \begin{axis}[
                ...
                \addplot3+ [
                    ...
                    contour gnuplot={
                            % At the moment, adding three plotted levels, gives
                            % error messages: "Missing character: There is no ` (U+0060) in font nullfont!"
                            % To avoid those, we just plot one level. If you need more, here you still can see how it works.
                            levels={0.5},
                            % levels={0.1, 0.5, 1},
                            draw color=rdylbu5,
                        },
            ...
            \end{axis}
        \end{tikzpicture}
    \caption[Mollier $h$-$x$ diagram]{%
        Mollier $h$-$x$ diagram showing specific humidity contours
...
\begin{figure}[tbp]
    ...
    \centering
    \pgfplotstableread{assets/data/diffuser.csv}{\diffusertable}%
    \begin{tikzpicture}
            \begin{axis}[%
                tuftelike,%
                axis y line*=left,%
...
\ContinuedFloat*
    ...
    \import{assets/data/}{matlab2tikz_table_example}
...
\cref{fig:tikz_circuit_example,fig:tikz_threedimensional_example}.
...
\begin{figure}[tbp]\ContinuedFloat*
    ...
    \end{tikzpicture}
    \caption[MATLAB2Ti\textit{k}Z data replotted in \LaTeX]{%
    ...
    \label{fig:matlab2tikz_pgfplots_overlay}
\end{figure}
...
\begin{example}[%
    ...
    \begin{center}
        ...
        \begin{minipage}[t]{0.55\linewidth}
            \includesvg[width=\linewidth]{compressor_impeller_isometric}
        \end{minipage}
    \end{center}
