...
\begin{alertblock}{Alert Block}
    Alert blocks retain their own red color regardless of theme.
\end{alertblock}

\begin{exampleblock}{Example Block}
    Example blocks retain their green color regardless of theme.
\end{exampleblock}
...
\begin{alertblock}{Alert Block}
    Alert blocks retain their red color on the dark background.
\end{alertblock}

\begin{exampleblock}{Example Block}
    Example blocks retain their green color on the dark background.
\end{exampleblock}
