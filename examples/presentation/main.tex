...
\begin{slideframe}
	...
	\begin{itemize}
		\item Built on KOMA-Script (scrbook, scrreprt, scrartcl)
		\item Compiled with LuaLaTeX for modern font and Unicode support
		\item Modular architecture with pluggable document types
...
\begin{slideframe}
	\begin{center}
		...
		{\Large Questions?}\par
		\vspace{12mm}
		{\large\texttt{github.com/WyattAu/OmniLaTeX-template}}
		\vfill
	\end{center}
\end{slideframe}
