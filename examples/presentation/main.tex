...
\author{Jane Doe}
\makeatletter\newcommand{\institute}[1]{\gdef\@institute{#1}}\makeatother\institute{Department of Computer Science, University of Examples}
\date{April 2026}
...
\begin{presentationframe}
    ...
    \begin{presentationblock}{Core Idea}
...
\begin{presentationframe}
    ...
    \begin{definitionblock}{Theorem (Euclid)}
...
\begin{presentationframe}
    ...
    \begin{presentationblock}{Minimal Example}
        \ttfamily\small
