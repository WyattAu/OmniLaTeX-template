...
\texttt{to[resistor, info=$R_1{=}100\,\Omega$]}.
...
\begin{longtblr}[
    ...
    Command                  & Description \\
    \midrule
    \verb|\annotationarrow|  & Arrow with a text label at the tip \\
    \verb|\wall|             & Hatched wall for boundary conditions \\
    \verb|\flowarrow|        & Directional flow arrow on a pipe or duct \\
    \verb|\arrowlabel|       & Text label positioned along an arrow \\
    \bottomrule
\end{longtblr}
