...
\begin{longtblr}[
    ...
    Command          & Purpose \\
    \midrule
    \verb|\toprule|    & Heavy rule at the top of the table \\
    \verb|\midrule|    & Medium rule below the header \\
    \verb|\bottomrule| & Heavy rule at the bottom of the table \\
    \verb|\addlinespace| & Insert extra vertical space between rows \\
    \bottomrule
\end{longtblr}
