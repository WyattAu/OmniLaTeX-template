...
\documentclass[
    language=english,
    doctype=book,              % Book-style with chapters
    institution=none,        % Generic (no institution branding)
    oneside,                 % Single-sided (screen viewing)
    loadGlossaries=true,          % Enable glossaries/acronyms
]{../../omnilatex}
...
% Define glossary entries used in this example.
% These supplement the bib2gls-loaded entries from bib/glossaries/.
...
Reference bibliography entries with \verb|\cite{}|: \cite{einstein1905}.
Multiple citations: \cite{birdNaturalLanguageProcessing2009,goossensLaTeXCompanion1993}.
...
This template uses \LaTeX{} for typesetting.
The TU Hamburg is a research university in Hamburg.
Using \LaTeX{} and TU Hamburg again.
